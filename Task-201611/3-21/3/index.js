...
(lib.result_mc = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(503.9,188.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// r1_l.png
	this.instance_1 = new lib.r1_l();
	this.instance_1.setTransform(21,194.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// result_b_2.png
	this.again = new lib.again();
	this.again.setTransform(316.5,791.3,1,1,0,0,0,154.7,51.8);
	this.again.alpha = 0.012;

	this.instance_2 = new lib.result_b_2();
	this.instance_2.setTransform(195.4,747.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.again}]}).wait(1));

	// r_man_1.png
	this.manmc = new lib.manmc();
	this.manmc.setTransform(326,401.9,1,1,0,0,0,181,208.5);

	this.timeline.addTween(cjs.Tween.get(this.manmc).wait(1));

	// 图层 1
	this.instance_3 = new lib.cover_bg_top();
...
p.nominalBounds = new cjs.Rectangle(0,0,644.9,1169.4);
